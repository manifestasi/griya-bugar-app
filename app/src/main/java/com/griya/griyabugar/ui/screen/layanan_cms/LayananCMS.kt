package com.griya.griyabugar.ui.screen.layanan_cms
...
fun LayananCMSScreen(
    ...
    * */
    ...
    Log.d("DIALOG BERHASIL", "DIALOG STATE TRUE : $dialog_state_true")
    Log.d("DIALOG BERHASIL", "DIALOG STATE FAILED : $dialog_state_failed")
    ...
    Scaffold(
        ...
        content = {
            ...
            if(isLoading == false){
                ...
                LazyColumn(
                    modifier = Modifier.fillMaxSize().padding(innerPadd),
