...
class LayananRepository @Inject constructor(
    ...
    * */
    ...
    fun getLayananData():Flow<Resource<List<LayananModel>>> = callbackFlow {
        ...
        if(user_id == null){
            ...
            val listener_result = firestore.collection(LAYANAN_COLLECTION)
    ...
    * */
    ...
    fun insertDataPemesanan(
        ...
        val insertTask =  firestore.collection(LAYANAN_COLLECTION)
            .add(map_layanan)
    ...
    * */
    fun updateDataLayanan(
        ...
        val updateTask =  firestore.collection(LAYANAN_COLLECTION)
            .document(uuid_doc)
            .update(
                field,
                new_value
    ...
    * */
    fun deleteDataLayanan(
        ...
        val deleteTask =  firestore.collection(LAYANAN_COLLECTION)
            .document(uuid_doc)
            .delete()
